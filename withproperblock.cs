...
namespace TicTacToeConsole
{
    ...
    static class Program
    {
        ...
        public static bool nextMoveContainsFork(long marks, long boardMarks)
        {
        ...
        public static int evaluate(long desiredMarks, long undesiredMarks, long newMark)
        {
            ...
            bool undesiredWon = CheckWinInAlgorithm(undesiredMarks);
        ...
        public static int minimax(long desiredMarks, long undesiredMarks, int depth, bool isMax, int alpha, int beta, long newMark)
        {
            ...
            //ulong state = (ulong)((newMark << (Highest * 2)) | (desiredMarks << Highest) | undesiredMarks | Convert.ToInt64(isMax));
            /*bool checkFullBoard()
            {
